...
(A) $\dfrac{z}{z+1}(\mathrm{e}^{-x^2}-\mathrm{e}^{-y^2})$.

(B) $\dfrac{z}{z+1}(\mathrm{e}^{-x^2}+\mathrm{e}^{-y^2})$.

(C) $-\dfrac{z}{z+1}(\mathrm{e}^{-x^2}-\mathrm{e}^{-y^2})$.

(D) $-\dfrac{z}{z+1}(\mathrm{e}^{-x^2}+\mathrm{e}^{-y^2})$.

\vfill
\newpage
{\large\bfseries 2025.2}
...
(B) $\int_0^l\dfrac{Gx}{(x^2+1)^{\frac{3}{2}}}\,\mathrm{d}x$.

(C) $\int_0^l\dfrac{G}{(x^2+1)^{\frac{3}{2}}}\,\mathrm{d}x$.

(D) $\int_0^l\dfrac{G(x+1)}{(x^2+1)^{\frac{3}{2}}}\,\mathrm{d}x$.

\vfill
\newpage
{\large\bfseries 2025.7}
...
\vfill
\newpage
{\large\bfseries 2025.11}

设 $\int_1^{+\infty}\dfrac{a}{x(2x+a)}\,\mathrm{d}x=\ln2$，则 $a=$\underline{\hspace{20mm}}.

\vfill
\newpage
{\large\bfseries 2025.12}

曲线 $y=\sqrt[3]{x^3-3x^2+1}$ 的渐近线方程为\underline{\hspace{20mm}}.

\vfill
\newpage
{\large\bfseries 2025.13}

$\lim\limits_{n\to\infty}\dfrac{1}{n^2}\left[\ln\dfrac{1}{n}+2\ln\dfrac{2}{n}+\cdots+(n-1)\ln\dfrac{n-1}{n}\right]=$\underline{\hspace{20mm}}.

\vfill
\newpage
{\large\bfseries 2025.14}

已知函数 $y=y(x)$ 由 $\begin{cases}x=\ln(1+2t),\\[4pt]2t-\int_1^{y+t^2}\mathrm{e}^{-u^2}\,\mathrm{d}u=0\end{cases}$ 确定，则 $\dfrac{\mathrm{d}y}{\mathrm{d}x}\bigg|_{t=0}=$\underline{\hspace{20mm}}.

\vfill
\newpage
{\large\bfseries 2025.15}

微分方程 $(2y-3x)\,\mathrm{d}x+(2x-5y)\,\mathrm{d}y=0$ 满足条件 $y(1)=1$ 的解为\underline{\hspace{20mm}}.

\vfill
\newpage
{\large\bfseries 2025.16}

设矩阵 $\boldsymbol{A}=(\boldsymbol{\alpha}_1,\boldsymbol{\alpha}_2,\boldsymbol{\alpha}_3,\boldsymbol{\alpha}_4)$，若 $\boldsymbol{\alpha}_1,\boldsymbol{\alpha}_2,\boldsymbol{\alpha}_3$ 线性无关，且 $\boldsymbol{\alpha}_1+\boldsymbol{\alpha}_2=\boldsymbol{\alpha}_3+\boldsymbol{\alpha}_4$，则方程组 $\boldsymbol{Ax}=\boldsymbol{\alpha}_1+4\boldsymbol{\alpha}_4$ 的通解为 $\boldsymbol{x}=$\underline{\hspace{20mm}}.

\vfill
\newpage
{\large\bfseries 2025.17}
