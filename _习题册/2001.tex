...
\vfill
\newpage
{\large\bfseries 2001.6}\quad {\small 原卷二（1）}
...
\vfill
\newpage
{\large\bfseries 2001.7}\quad {\small 原卷二（2）}
...
\vfill
\newpage
{\large\bfseries 2001.8}\quad {\small 原卷二（3）}
...
\vfill
\newpage
{\large\bfseries 2001.9}\quad {\small 原卷二（4）}
...
\vfill
\newpage
{\large\bfseries 2001.10}\quad {\small 原卷二（5）}

已知函数 $y = f(x)$ 在其定义域内可导，它的图形如下图所示，则其导函数 $y = f'(x)$ 的图形为（　）

\begin{center}\includegraphics[width=.62\textwidth,height=65mm,keepaspectratio]{_题图/2001.10.1.png}\end{center}

\begin{center}\includegraphics[width=.9\textwidth,height=75mm,keepaspectratio]{_题图/2001.10.2.png}\end{center}

\vfill
\newpage
{\large\bfseries 2001.11}\quad {\small 原卷三}

求 $\int \dfrac{dx}{(2x^2 + 1)\sqrt{x^2 + 1}}$.

\vfill
\newpage
{\large\bfseries 2001.12}\quad {\small 原卷四}

求极限 $\lim_{t \to x} \left(\dfrac{\sin t}{\sin x}\right)^{\dfrac{x}{\sin t - \sin x}}$，记此极限为 $f(x)$，求函数 $f(x)$ 的间断点并指出其类型.

\vfill
\newpage
{\large\bfseries 2001.13}\quad {\small 原卷五}
...
\vfill
\newpage
{\large\bfseries 2001.14}\quad {\small 原卷六}

设函数 $f(x)$ 在 $[0, +\infty)$ 上可导，$f(0) = 0$，且其反函数为 $g(x)$. 若 $\int_0^{f(x)} g(t) \, dt = x^2 e^x$，求 $f(x)$.

\vfill
\newpage
{\large\bfseries 2001.15}\quad {\small 原卷七}
...
\vfill
\newpage
{\large\bfseries 2001.16}\quad {\small 原卷八}
...
\vfill
\newpage
{\large\bfseries 2001.19}\quad {\small 原卷十一}
...
\vfill
\newpage
{\large\bfseries 2001.20}\quad {\small 原卷十二}
